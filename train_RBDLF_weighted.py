...
from config_RBDLF_weighted import opt
...
from trainers.trainer import cls_tripletTrainer_RBDLF_weighted
...
def train(**kwargs):
    ...
    reid_trainer = cls_tripletTrainer_RBDLF_weighted(opt, model, optimizer, dataset.num_train_pids, summary_writer)
