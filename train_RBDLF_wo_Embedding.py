...
from config_RBDLF_wo_Embedding import opt
from datasets import data_manager
from datasets.data_loader import ImageData
from datasets.samplers import RandomIdentitySampler
from models.networks import ResNetBuilder, IDE, Resnet, BFE, RBDLF_BFE,RBDLF_BFE_wo_Embedding
...
def train(**kwargs):
    ...
    # RBDLF-BDB wo Embedding
    elif opt.model_name == 'RBDLF_wo_Embedding':
        model = RBDLF_BFE_wo_Embedding(dataset.num_train_pids, 1.0, 0.33)
