...
from config_RBDLF_wo_cutout import opt
...
from utils.transforms import TestTransform, TrainTransform_wo_cutout
...
def train(**kwargs):
    ...
    trainloader = DataLoader(
        ImageData(dataset.train, TrainTransform_wo_cutout(opt.datatype)),
