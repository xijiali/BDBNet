...
from config_original_milestone_optimizer_distiller import opt
...
from trainers.trainer import cls_tripletTrainerDistillerOriginal
...
from models.distiller import DistillerOriginal
...
def train(**kwargs):
    ...
    d_net = DistillerOriginal(t_net, s_net)
    if use_gpu:
    ...
    reid_trainer = cls_tripletTrainerDistillerOriginal(opt, d_net, optimizer, dataset.num_train_pids, summary_writer)
