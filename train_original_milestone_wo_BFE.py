...
from config_original_milestone_wo_BFE import opt
...
from trainers.trainer import cls_tripletTrainer_wo_BFE
...
def train(**kwargs):
    ...
    reid_trainer = cls_tripletTrainer_wo_BFE(opt, model, optimizer, criterion, summary_writer)
